...
export default function MyKaufchancen() {
  ...
  const loadData = async () => {
    ...
    setLoading(true);
    try {
      // Load available Kaufchancen (active auctions in kaufchance status)
      const { data: kaufchanceData, error: kaufchanceError } = await supabase
        .from("auctions")
        .select(`
          id,
          current_bid,
      ...
      if (kaufchanceError) throw kaufchanceError;
      setKaufchancen((kaufchanceData as unknown as KaufchanceAuction[]) || []);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Fahrzeuge, deren Auktion ohne Verkauf endete - jetzt mit Direktangebot kaufen
        </p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          <TabsTrigger value="browse">
            Verfügbare Kaufchancen ({kaufchancen.length})
          </TabsTrigger>
            ...
            <Card className="p-12">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Aktuell sind keine Fahrzeuge als Kaufchance verfügbar. Schauen Sie später wieder vorbei!
                </p>
                <Button asChild>
                        ...
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Die Auktion endete ohne Verkauf. Sie können jetzt ein Direktangebot abgeben.
                            </p>
                          </div>
