...
export const wohnmobilpreise2026: LandingPageConfig = {
  ...
  sections: [
    {
      title: "Status quo Frühjahr 2026: Preise weiter unter Druck",
      content:
      ...
      items: [
        {
          title: "Junge Gebrauchte (1–3 Jahre): –12 bis –18 % seit 2024",
          description:
        ...
        {
          title: "Mittelalte (4–7 Jahre): –7 bis –10 % seit 2024",
          description:
        ...
        {
          title: "Ältere (8+ Jahre): –4 bis –7 % seit 2024",
          description:
        ...
        {
          title: "Neuwagen-Bereich: starke Rabatte, fragile Nachfrage",
          description:
      ...
      ctaText: "Was ist mein Wohnmobil heute wert?",
      ctaHref: "/wertrechner",
    },
    {
      title: "Warum die Preise 2026 nicht stoppen",
      content:
      ...
      items: [
        {
          title: "Anhaltend hohe Lebenshaltungskosten",
          description:
        ...
        {
          title: "Hohe Finanzierungskosten",
          description:
        ...
        {
          title: "Generation Wohnmobil-Müde",
          description:
        ...
        {
          title: "Klimadebatte & alternative Antriebe",
          description:
    ...
    {
      title: "Prognose für 2026 nach Aufbau-Typ",
      content:
      ...
      items: [
        {
          title: "Vollintegrierte: –6 bis –10 %",
          description:
    ...
    {
      title: "Was bedeutet das für Verkäufer? 4 Handlungsempfehlungen",
      content:
        "Auf Basis der aktuellen Datenlage sind das die wichtigsten Empfehlungen für 2026.",
      items: [
        {
          title: "1. Realistische Preiserwartung haben",
          description:
        ...
        {
          title: "2. Nicht auf Bessergeräte warten",
          description:
        ...
        {
          title: "3. Auf Auktionsplattformen setzen",
          description:
            "In einem Käufermarkt sind Privatverkäufe besonders zäh und risikobehaftet (Reifenkicker, Betrugsversuche, lange Standzeit). Auktionen mit Händler-Bietergemeinschaft bringen schneller realistische Preise.",
        },
        {
          title: "4. Aufbereitung lohnt sich mehr denn je",
          description:
      ...
      ctaText: "Wertanalyse jetzt starten",
      ctaHref: "/wertrechner",
    },
    {
      title: "Verkauf in einem fallenden Markt: So minimieren Sie den Schaden",
      content:
        "Über CaravanWert verkaufen Sie auch in einem schwierigen Marktumfeld zu marktgerechten Preisen — schnell, sicher und ohne Privatverkaufs-Risiken.",
      items: [
        {
          title: "1.500+ Händler bieten in 24 Stunden",
          description:
            "Maximale Nachfrage-Konzentration in 24 Stunden. Sie sehen direkt das beste Gebot — ohne wochenlanges Inserate-Schalten und Anrufe-Beantworten.",
        },
        {
          title: "Mindestpreis-Schutz",
          description:
            "Ihr Mindestpreis nicht erreicht? Auktion verfällt kostenlos. Kein Verkaufsdruck, keine versteckten Kosten.",
        },
        {
          title: "Komplette digitale Abwicklung",
          description:
            "Echtzeit-Banküberweisung bei Übergabe, deutschlandweite Abholung. Sie verlassen den eigenen Hof nicht.",
        },
      ],
  ...
  faqItems: [
    {
      question: "Wie stark fallen die Wohnmobilpreise 2026?",
      answer:
    ...
    {
      question: "Wann hört der Preisverfall auf?",
      answer:
    ...
    {
      question: "Welche Aufbauart verliert am wenigsten Wert?",
      answer:
    ...
    {
      question: "Soll ich jetzt verkaufen oder noch warten?",
      answer:
    ...
    {
      question: "Sind Premium-Marken eine sichere Bank?",
      answer:
    ...
    {
      question: "Wie wirken sich neue E-Wohnmobile auf den Diesel-Markt aus?",
      answer:
    ...
    {
      question: "Was ist mit der Wohnmobil-Steuer?",
      answer:
    ...
    {
      question: "Wie zuverlässig sind die Marktdaten von CaravanWert?",
      answer:
        "Wir analysieren wöchentlich hunderte aktive Inserate, abgeschlossene Auktionen über unser Portal und Marktdaten unserer Partner. Die Datenbasis ist deutlich aktueller als Schwacke (monatlich) oder DAT (monatlich) und reagiert schnell auf Marktverschiebungen.",
    },
    {
      question: "Werden Vermieter weiterhin Bestände abstoßen?",
      answer:
    ...
    {
      question: "Profitieren Käufer 2026?",
      answer:
    ...
    {
      question: "Sollte ich auf eine bessere Marktlage warten?",
      answer:
    ...
    {
      question: "Wie genau ist der Wertrechner trotz volatilem Markt?",
      answer:
    ...
    {
      question: "Was unterscheidet die Marktlage 2026 von 2025?",
      answer:
    ...
    {
      question: "Sind Wohnwagen in einer ähnlichen Situation?",
      answer:
    ...
    {
      question: "Was sagen andere Marktexperten zur Lage?",
      answer:
    ...
    {
      question: "Macht es Sinn, in der Krise ein Wohnmobil zu verkaufen?",
      answer:
