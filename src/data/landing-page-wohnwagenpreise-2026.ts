...
export const wohnwagenpreise2026: LandingPageConfig = {
  ...
  primaryCta: { text: "Aktuellen Marktwert prüfen", href: "/wertrechner" },
  secondaryCta: { text: "Verkauf jetzt starten", href: "/verkaufen/wizard" },
  sections: [
    {
      title: "Wo der Wohnwagen-Markt 2026 wirklich steht",
      content:
      ...
      items: [
        {
          title: "Aktueller Stand: −7 bis −9 % gegenüber Vorjahr",
          description:
        ...
        {
          title: "Angebotsschwemme dauert an",
          description:
        ...
        {
          title: "Käuferverhalten: deutlich vorsichtiger",
          description:
        ...
        {
          title: "Stellplatz-Krise verschärft Verkaufsdruck",
          description:
    ...
    {
      title: "Preisentwicklung nach Segment",
      content:
      ...
      items: [
        {
          title: "Segment 1: Premium-Familienwohnwagen (Tabbert, Hobby Premium, Fendt Saphir/Tendenza)",
          description:
        ...
        {
          title: "Segment 2: Mittelklasse (Knaus Südwind, LMC Style, Hobby De Luxe)",
          description:
        ...
        {
          title: "Segment 3: Einsteiger / Sommerwohnwagen (Caravelair, Sterckeman, Adria Action)",
          description:
        ...
        {
          title: "Segment 4: Kult-Modelle (Eriba Touring, Knaus Sport)",
          description:
            "Wertverlust 2025: ca. 3–5 % (manche Sondermodelle sogar Wertstabil). Liebhabergeschäft, kleiner Markt, treue Käuferschaft.",
        },
        {
          title: "Segment 5: Tandemachser & Luxus-Caravans (Knaus Südwind 580, Hobby Prestige)",
          description:
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "2027: mögliche Stabilisierung — kein Boom",
          description:
        ...
        {
          title: "Mittelfristig (2028+): Strukturwandel",
          description:
    ...
    {
      title: "Was Verkäufer 2026 konkret tun sollten",
      content:
        "Konkrete Empfehlung basierend auf der aktuellen Marktlage:",
      items: [
        {
          title: "Verkauf in 2026 abschließen — wenn möglich H1",
          description:
        ...
        {
          title: "Auf Premium-Käufergruppe zielen",
          description:
        ...
        {
          title: "Auktion statt Privat-Inserat",
          description:
            "Privat-Inserate dauern aktuell 8–14 Wochen. Über CaravanWert-Auktion: 24–48 Stunden bis zum Höchstgebot von 1.500+ verifizierten Händlern.",
        },
        {
          title: "Realistischen Preis ansetzen",
          description:
        ...
        {
          title: "Wartung up-to-date halten",
          description:
    ...
    {
      title: "Mit CaravanWert: 24h-Auktion zum aktuellen Marktpreis",
      content:
        "Statt monatelang im fallenden Markt zu hoffen, lassen Sie 1.500+ Händler bieten. Sie sehen das beste Gebot in maximal 24 Stunden — und Mindestpreis schützt Sie vor schlechten Angeboten.",
      items: [
        {
          title: "Echte Marktpreise statt Wunschpreise",
          description:
            "Händler bieten kompetitiv gegeneinander. Das Ergebnis ist der echte aktuelle Marktpreis — nicht ein theoretischer Wunschpreis aus 2022.",
        },
        {
          title: "Mindestpreis-Garantie",
          description:
            "Sie legen den Mindestpreis fest. Wird er nicht erreicht, müssen Sie nicht verkaufen. Auktion verfällt kostenlos.",
        },
        {
          title: "Kostenlos für Verkäufer",
          description:
            "Inserieren, Bewertung, Auktion, Abwicklung — alles kostenlos. Die Provision zahlt der Händler. Sie bekommen den vollen Auktionspreis ausgezahlt.",
        },
      ],
  ...
  faqItems: [
    {
      question: "Fallen die Wohnwagenpreise 2026 weiter?",
      answer:
    ...
    {
      question: "Wann erholen sich die Wohnwagenpreise wieder?",
      answer:
    ...
    {
      question: "Welche Wohnwagen-Marken halten den Wert am besten?",
      answer:
    ...
    {
      question: "Welche Marken verlieren am stärksten?",
      answer:
    ...
    {
      question: "Was wenn ich auf eine Markterholung warte?",
      answer:
    ...
    {
      question: "Wie hoch ist der Preisunterschied zwischen Privat- und Händlerverkauf?",
      answer:
        "Aktuell ca. 15–25 % (Händler-Inzahlungnahme). Bei Auktionsplattformen (1.500+ Händler bieten kompetitiv): nur 5–10 % Abschlag — bei deutlich einfacherer Abwicklung.",
    },
    {
      question: "Beeinflusst die Stellplatz-Krise die Wohnwagenpreise?",
      answer:
    ...
    {
      question: "Wie wirkt sich die Inflation auf den Wohnwagenmarkt aus?",
      answer:
    ...
    {
      question: "Sind wintertaugliche Wohnwagen wertstabiler?",
      answer:
    ...
    {
      question: "Wie hoch ist mein Wohnwagen aktuell tatsächlich wert?",
      answer:
    ...
    {
      question: "Hat es Sinn, vor dem Verkauf zu modernisieren?",
      answer:
    ...
    {
      question: "Welche Wohnwagen-Größe verkauft sich am besten?",
      answer:
    ...
    {
      question: "Lohnt sich der Verkauf an einen Sofort-Aufkäufer?",
      answer:
        "Selten. Sofort-Aufkäufer am Telefon zahlen typisch 25–40 % unter Marktwert. Über Auktionsplattform mit Händler-Bietergemeinschaft erreichen Sie 90–95 % des Marktwerts bei vergleichbarer Geschwindigkeit.",
    },
    {
      question: "Was bringt eine professionelle Bewertung?",
      answer:
