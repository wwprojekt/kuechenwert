...
const WohnmobilWert = () => {
  ...
  const handleSelectionWithAutoNext = useCallback(
    (field: string, value: string, shouldAutoNext: boolean = true) => {
      if (autoNextTimerRef.current) {
        clearTimeout(autoNextTimerRef.current);
      }
  ...
  return (
    <PageLayout
      title="Was ist mein Wohnmobil wert? — Kostenlose Sofort-Bewertung"
      description="Erfahren Sie sofort, was Ihr Wohnmobil wert ist. Kostenloser Wertrechner mit Sofort-Ergebnis in nur 4 Schritten. Jetzt Wohnmobil-Wert ermitteln!"
      keywords="was ist mein wohnmobil wert, wohnmobil wert ermitteln, wohnmobil bewertung kostenlos, wohnmobil wertrechner, was ist mein camper wert"
      canonicalPath="/was-ist-mein-wohnmobil-wert"
    >
      <PageHero size="sm">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground">
            Erhalten Sie in nur 4 Schritten eine kostenlose Wertschätzung für Ihr Wohnmobil.
          </p>
        </div>
      </PageHero>
          ...
          <Card className="p-8">
              ...
              <div className="space-y-8">
                ...
                {!leadSubmitted ? (
                  <div className="border-t pt-8">
                    <h3 className="font-semibold text-lg mb-4">Genauere Bewertung gewünscht?</h3>
                    <p className="text-muted-foreground mb-6">
                      Hinterlassen Sie Ihre Kontaktdaten und unsere Experten melden sich mit einer
                      detaillierten Einschätzung bei Ihnen.
                    </p>
            ...
            {step < 5 && (
              <div className="flex justify-between mt-8 pt-6 border-t">
                ...
                <Button onClick={nextStep} disabled={!canProceed()} className="gradient-hero">
