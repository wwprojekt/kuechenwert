...
const BlogPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Helmet>
        <title>{`Blog - Ratgeber & News rund um Wohnmobile | ${siteName}`}</title>
        <meta 
          name="description" 
          content="Aktuelle Artikel, Tipps und Ratgeber rund um den Kauf und Verkauf von Wohnmobilen. Markttrends, Bewertungstipps und mehr." 
        />
        <link rel="canonical" href="https://caravanwert.de/blog" />
        <meta property="og:url" content="https://caravanwert.de/blog" />
        <meta property="og:title" content={`Blog - Ratgeber & News rund um Wohnmobile | ${siteName}`} />
        <meta property="og:description" content="Aktuelle Artikel, Tipps und Ratgeber rund um den Kauf und Verkauf von Wohnmobilen." />
      </Helmet>
