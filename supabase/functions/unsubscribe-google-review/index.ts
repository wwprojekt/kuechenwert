...
function htmlConfirm(token: string): Response {
  ...
  const html = page(
    ...
    <p style="font-size:16px;color:#374151;line-height:1.6;">
      Möchten Sie keine weiteren Erinnerungen erhalten, dass Sie KuechenWert auf Google bewerten könnten?
    </p>
    ...
    <p style="margin-top:32px;font-size:13px;color:#6b7280;">
      Hinweis: Andere Benachrichtigungen aus Ihrem KuechenWert-Konto (z. B. Auktions-Updates) sind davon nicht betroffen.
    </p>
    `,
  );
...
function htmlSuccess(email: string): Response {
  ...
  const html = page(
    ...
    <p style="font-size:16px;color:#374151;line-height:1.6;">
      Sie erhalten von uns keine weitere Erinnerung in dieser Sache. Falls Sie noch ein aktives Konto bei KuechenWert haben, sind alle dort eingestellten Benachrichtigungen davon nicht betroffen.
    </p>
    <p style="margin-top:32px;">
      <a href="https://kuechenwert24.de" style="display:inline-block;background:#1f8aa2;color:#fff;text-decoration:none;padding:12px 24px;border-radius:6px;font-weight:500;">Zur Startseite</a>
    </p>
    <p style="margin-top:32px;font-size:13px;color:#6b7280;">
...
<title>${escapeHtml(title)} – KuechenWert</title>
<style>
