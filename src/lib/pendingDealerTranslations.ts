...
const de: PendingDealerTranslations = {
  ...
  docUpload: 'Hochladen',
  docInfoBox:
    'Erlaubte Dateiformate: PDF, JPG, PNG (max. 10 MB). Ihre Dokumente werden vertraulich behandelt und nur zur Verifizierung Ihres Händlerkontos verwendet. Nach der Prüfung erhalten Sie eine E-Mail-Benachrichtigung.',
  docInvalidType: 'Ungültiger Dateityp. Erlaubt: PDF, JPG, PNG',
  docFileTooLarge: 'Datei zu groß. Maximal 10 MB erlaubt.',
...
const en: PendingDealerTranslations = {
  ...
  docUpload: 'Upload',
  docInfoBox:
    'Allowed file formats: PDF, JPG, PNG (max. 10 MB). Your documents are treated confidentially and used only for dealer account verification. You will receive an email notification after the review.',
  docInvalidType: 'Invalid file type. Allowed: PDF, JPG, PNG',
  docFileTooLarge: 'File too large. Maximum 10 MB allowed.',
...
const nl: PendingDealerTranslations = {
  ...
  docUpload: 'Uploaden',
  docInfoBox:
    'Toegestane bestandsformaten: PDF, JPG, PNG (max. 10 MB). Uw documenten worden vertrouwelijk behandeld en alleen gebruikt voor verificatie van uw dealerrekening. Na de beoordeling ontvangt u een e-mailmelding.',
  docInvalidType: 'Ongeldig bestandstype. Toegestaan: PDF, JPG, PNG',
  docFileTooLarge: 'Bestand te groot. Maximaal 10 MB toegestaan.',
...
const fr: PendingDealerTranslations = {
  ...
  docFileTooLarge: 'Fichier trop volumineux. Maximum 10 Mo autorisé.',
...
const it: PendingDealerTranslations = {
  ...
  docUpload: 'Caricare',
  docInfoBox:
    'Formati di file consentiti: PDF, JPG, PNG (max. 10 MB). I vostri documenti sono trattati in modo confidenziale e utilizzati solo per la verifica del vostro account. Riceverete una notifica via e-mail dopo la verifica.',
  docInvalidType: 'Tipo di file non valido. Consentiti: PDF, JPG, PNG',
  docFileTooLarge: 'File troppo grande. Massimo 10 MB consentiti.',
...
const es: PendingDealerTranslations = {
  ...
  docUpload: 'Subir',
  docInfoBox:
    'Formatos de archivo permitidos: PDF, JPG, PNG (máx. 10 MB). Sus documentos se tratan de forma confidencial y se utilizan únicamente para la verificación de su cuenta. Recibirá una notificación por correo electrónico tras la revisión.',
  docInvalidType: 'Tipo de archivo no válido. Permitidos: PDF, JPG, PNG',
  docFileTooLarge: 'Archivo demasiado grande. Máximo 10 MB permitido.',
...
const pt: PendingDealerTranslations = {
  ...
  docUpload: 'Carregar',
  docInfoBox:
    'Formatos de ficheiro permitidos: PDF, JPG, PNG (máx. 10 MB). Os seus documentos são tratados de forma confidencial e utilizados apenas para verificação da sua conta. Receberá uma notificação por e-mail após a análise.',
  docInvalidType: 'Tipo de ficheiro inválido. Permitidos: PDF, JPG, PNG',
  docFileTooLarge: 'Ficheiro demasiado grande. Máximo 10 MB permitido.',
...
const pl: PendingDealerTranslations = {
  ...
  docUpload: 'Prześlij',
  docInfoBox:
    'Dozwolone formaty plików: PDF, JPG, PNG (maks. 10 MB). Twoje dokumenty są traktowane poufnie i wykorzystywane wyłącznie do weryfikacji konta. Po weryfikacji otrzymasz powiadomienie e-mail.',
  docInvalidType: 'Nieprawidłowy typ pliku. Dozwolone: PDF, JPG, PNG',
  docFileTooLarge: 'Plik za duży. Maksymalnie 10 MB.',
