...
export const wohnmobilVerkaufspreis: LandingPageConfig = {
  ...
  sections: [
    {
      title: "Warum die Preisfindung 2026 schwieriger ist als je zuvor",
      content:
      ...
      items: [
        {
          title: "Massiver Angebotsüberhang",
          description:
        ...
        {
          title: "Kaufzurückhaltung der Verbraucher",
          description:
        ...
        {
          title: "Listen-Preise sind nicht Verkaufspreise",
          description:
        ...
        {
          title: "Schwacke ist für Privatverkäufer nicht zugänglich",
          description:
      ...
      ctaText: "Aktuellen Marktpreis berechnen",
      ctaHref: "/wertrechner",
    },
    {
      title: "Diese 4 Methoden funktionieren NICHT",
      content:
        "Bevor wir zur richtigen Vorgehensweise kommen — hier die Klassiker, an denen die meisten Wohnmobil-Verkäufer scheitern.",
      items: [
        {
          title: "1. Vergleich mit mobile.de-Inseraten",
          description:
        ...
        {
          title: "2. Schwacke-Auskunft beim Händler erfragen",
          description:
        ...
        {
          title: "3. Aufkäufer-Hotline anrufen",
          description:
        ...
        {
          title: "4. Bauchgefühl + investierte Kosten",
          description:
    ...
    {
      title: "So machen Sie es richtig: Marktpreis-Berechnung in 3 Schritten",
      content:
      ...
      items: [
        ...
        {
          title: "Schritt 2: Verkaufskanal-Korrektur anwenden",
          description:
            "Privatverkauf an Endkunde: Marktwert × 1,00. Verkauf an Händler: Marktwert × 0,80–0,85. Auktion über CaravanWert: Marktwert × 0,90–0,95 (Händlernetzwerk treibt den Preis nach oben).",
        },
        {
          title: "Schritt 3: Verhandlungsspielraum einplanen",
          description:
    ...
    {
      title: "Wertbeeinflussende Faktoren — was treibt den Preis?",
      content:
      ...
      items: [
        ...
        {
          title: "Laufleistung & Erstzulassung (±10 %)",
          description:
    ...
    {
      title: "Wohnmobil mühelos online verkaufen",
      content:
        "Sie haben den Marktpreis ermittelt — was nun? Statt monatelang Anrufe und Besichtigungen zu managen, übergeben Sie den Verkauf einfach unserer Auktionsplattform.",
      items: [
        {
      ...
      ctaText: "Verkaufsprozess starten",
      ctaHref: "/verkaufen/wizard",
    },
  ],
  faqItems: [
    {
      question: "Welcher Verkaufspreis ist für mein Wohnmobil realistisch?",
      answer:
    ...
    {
      question: "Wie hoch sollte mein Verhandlungsspielraum sein?",
      answer:
    ...
    {
      question: "Was ist der Unterschied zwischen Wunschpreis und Marktpreis?",
      answer:
    ...
    {
      question: "Soll ich den Preis lieber zu hoch oder zu niedrig ansetzen?",
      answer:
    ...
    {
      question: "Wie genau ist der CaravanWert-Wertrechner?",
      answer:
    ...
    {
      question: "Verändert sich der Marktwert über die Zeit?",
      answer:
    ...
    {
      question: "Wie viel ist meine Sonderausstattung wert?",
      answer:
    ...
    {
      question: "Spielt die Region eine Rolle für den Preis?",
      answer:
    ...
    {
      question: "Was wenn mein Wohnmobil noch finanziert ist?",
      answer:
    ...
    {
      question: "Lohnt sich eine professionelle Aufbereitung vor dem Verkauf?",
      answer:
    ...
    {
      question: "Welche Dokumente verbessern den erzielbaren Preis?",
      answer:
    ...
    {
      question: "Kann ich eine zweite Meinung zum Preis einholen?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Sowohl der Wertrechner als auch die Expertenbewertung sind 100 % kostenlos und unverbindlich. Auch der spätere Verkauf über unsere Auktionsplattform ist für Verkäufer kostenfrei — die Provision zahlt der Händler.",
    },
    {
      question: "Wie lange dauert es, einen Verkauf abzuschließen?",
      answer:
        "Privatverkauf: 4–12 Wochen sind typisch. Händler-Inzahlungnahme: 1–3 Tage, aber 15–25 % Wertabschlag. Auktion über CaravanWert: 24 Stunden bis zum Höchstgebot, dann 2–5 Tage bis zur Übergabe.",
    },
    {
      question: "Soll ich auf mehreren Plattformen gleichzeitig inserieren?",
      answer:
        "Beim klassischen Inserate-Modell: ja, das erhöht die Reichweite. Beim Auktionsmodell von CaravanWert: nicht nötig, da Sie in einem 24-Stunden-Fenster Gebote von 1.500+ Händlern erhalten — das ist quantitativ schon Maximum.",
    },
  ],
  relatedSlugs: [
