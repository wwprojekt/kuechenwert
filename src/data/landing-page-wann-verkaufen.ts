...
export const wannWohnmobilVerkaufen: LandingPageConfig = {
  slug: "wann-wohnmobil-verkaufen",
  path: "/wann-wohnmobil-verkaufen",
  title: "Wann Wohnmobil verkaufen? Bester Verkaufszeitpunkt 2026",
  metaDescription:
    "Wann ist der beste Zeitpunkt zum Verkauf eines Wohnmobils? Saisonale Preisunterschiede, Marktlage 2026, Wertverlust pro Monat — und warum „besser jetzt als später\" gerade besonders gilt.",
  keywords:
    "wann wohnmobil verkaufen, wohnmobil verkaufen wann, bester verkaufszeitpunkt wohnmobil, wohnmobil verkaufen jahreszeit, wohnmobil saisonal verkaufen, wann reisemobil verkaufen, wohnmobil verkaufen frühling, wohnmobil verkaufen winter",
  h1: "Wann ist der beste Zeitpunkt, ein Wohnmobil zu verkaufen?",
  heroSubtitle:
  ...
  sections: [
    {
      ...
      items: [
        {
          title: "Aktueller Wertverlust: 1,5–2,5 % pro Quartal",
          description:
    ...
    {
      title: "Saisonale Preisunterschiede im Detail",
      content:
      ...
      items: [
        {
          title: "März – April: TOP-Verkaufsphase",
          description:
        ...
        },
        {
          ...
          description:
            "Käufernachfrage bricht ein. Privatverkauf wird zäh, Preise unter dem Jahresdurchschnitt. Wer jetzt verkaufen muss, sollte besser über Auktionsplattform mit Händlerbeteiligung gehen — Händler kaufen ganzjährig.",
        },
        {
    ...
    {
      title: "Diese 4 Faktoren beeinflussen den richtigen Zeitpunkt",
      content:
      ...
      items: [
        ...
        {
          title: "Persönliche Lebenssituation",
          description:
    ...
    {
      title: "Was kostet Warten wirklich? Eine Beispielrechnung",
      content:
      ...
      items: [
        {
          ...
          description:
            "Marktwert 55.000 €, saisonaler Abschlag 3 % = Erlös ca. 53.350 €. Über CaravanWert-Auktion: 53.350 € abzüglich ca. 5 % Verkaufskanal-Abschlag = 50.700 €.",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Auktion läuft maximal 24 Stunden, Sie sehen das beste Gebot. Mindestpreis nicht erreicht? Auktion verfällt kostenlos, Sie können neu starten.",
        },
        {
          title: "Komplett digitale Abwicklung",
          description:
            "Echtzeit-Banküberweisung, deutschlandweite Abholung durch den Händler. Sie verlassen den eigenen Hof nicht.",
        },
      ],
  ...
  faqItems: [
    {
      question: "Wann ist der absolut beste Monat zum Wohnmobil-Verkauf?",
      answer:
    ...
    },
    {
      ...
      answer:
        "November bis Februar sind die schwächsten Monate. Wenn es der Zeitplan erlaubt, lieber 8–10 Wochen warten und im März/April online gehen. Ausnahme: Verkauf an Händler oder über Händler-Auktionsplattformen — die sind ganzjährig stabil.",
    },
    {
      question: "Lohnt es sich zu warten, wenn der Markt steigt?",
      answer:
    ...
    {
      question: "Wie viel Wert verliert ein Wohnmobil pro Jahr?",
      answer:
    ...
    {
      question: "Spielt das Wetter eine Rolle für den Verkaufserfolg?",
      answer:
    ...
    {
      question: "Wie wirken sich neue Modelljahrgänge auf den Markt aus?",
      answer:
    ...
    {
      question: "Ist ein Verkauf vor einer großen Wartung sinnvoll?",
      answer:
    ...
    {
      question: "Hat der Verkaufstag der Woche einen Einfluss?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Sofort-Verkauf an einen Händler über Auktionsplattform: 24–48 Stunden bis zum Geld. Das ist die schnellste seriöse Option. Sofort-Aufkäufer am Telefon zahlen oft 25–40 % unter Marktwert — diese Notlösung wirklich nur als allerletzten Ausweg.",
    },
    {
      question: "Sollte ich vor oder nach dem Urlaub verkaufen?",
      answer:
    ...
    {
      question: "Lohnt es sich, auf bessere Wirtschaftslage zu warten?",
      answer:
    ...
    {
      question: "Was ist mit Sonderausstattung — beeinflusst die den Zeitpunkt?",
      answer:
    ...
    {
      question: "Beeinflusst die Lage am Kraftstoffmarkt den Verkauf?",
      answer:
