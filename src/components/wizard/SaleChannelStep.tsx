    ...
    <div className="space-y-3 sm:space-y-6 animate-fade-in">
      <div className="mb-3 sm:mb-6">
        ...
        <p className="text-xs sm:text-base text-muted-foreground">
          Wählen Sie Ihren Verkaufsweg, geben Sie Ihren Wunschpreis und Ihre Telefonnummer an.
        </p>
      </div>
      ...
      <div className="space-y-3">
        <Label className={cn("text-base font-semibold", fieldErrors.saleChannel && "text-red-600")}>
          Wie möchten Sie verkaufen? <span className="text-red-500">*</span>
        </Label>
        <RadioGroup
        ...
        <div className="space-y-2 animate-fade-in">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData({ instantPrice: e.target.value ? parseInt(e.target.value) : null })
              }
              min={1}
        ...
        <div className="space-y-2 animate-fade-in">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData({ reservePrice: e.target.value ? parseInt(e.target.value) : null })
              }
              min={1}
          ...
          {fieldErrors.reservePrice ? (
            ...
            <div className="space-y-1">
              <p className="text-xs text-muted-foreground leading-relaxed">
                <span className="font-medium text-foreground">Schutz für Sie:</span> Niemand kann Ihr Fahrzeug
                unter diesem Preis kaufen.
              </p>
              <p className="text-xs text-muted-foreground/80 leading-snug">
                <span className="font-medium">Tipp:</span> Wählen Sie den niedrigsten Preis, zu dem Sie noch
                verkaufen würden – Händler überbieten ihn in der Auktion meist deutlich.
              </p>
            </div>
          )}
        </div>
      ...
      <div className="space-y-4">
        ...
        {/* Anzeige der bereits in Step 5 erfassten Daten – nicht editierbar hier */}
        {(formData.customerName || formData.customerEmail) && (
          <div className="bg-muted/50 rounded-lg p-3 flex items-start gap-3">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <p className="text-xs mt-0.5">Bereits erfasst – Änderung später im Konto möglich.</p>
            </div>
          </div>
        )}
        ...
        <div className="space-y-2">
          <Label
            ...
            className={cn("flex items-center gap-2", fieldErrors.customerPhone && "text-red-600")}
          >
