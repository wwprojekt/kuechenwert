/**
 * Funnel B Stammdaten („Studio-Angebot unterbieten“), gemeinsam für den
 * Funnel (Frontend-Re-Export src/config/funnel-b-stammdaten.ts) und die
 * Anzeige der Angaben in Studio-Portal, Projektseite und E-Mails
 * (describeFunnelB in funnel-a-catalog.ts).
 *
 * Diese Listen stimmen 1:1 mit den Seeds in
 * `supabase/migrations/002_funnel_b_pricing_stammdaten.sql` ueberein.
 * Gespeichert werden Slugs (Front-Material und Arbeitsplatten-Dekor als Name).
 */
