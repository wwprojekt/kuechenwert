...
const de: Translations = {
  ...
  placeholderCompanyName: 'Ihr Küchenstudio',
  ...
  // Page header
  pageTitle: 'Als Küchen-Händler registrieren',
  pageSubtitle: 'Werden Sie Teil unseres Küchen-Partnernetzwerks und erhalten Sie qualifizierte Leads direkt von privaten Küchen-Verkäufern',
  pageBadge: 'Händler-Registrierung',
  // Benefits
  benefitExclusiveTitle: 'Qualifizierte Küchen-Leads',
  benefitExclusiveDesc: 'Anfragen direkt von privaten Küchen-Verkäufern',
  benefitNetworkTitle: 'Kostenlos starten',
  benefitNetworkDesc: 'Keine Grundgebühr – nur bei erfolgreichem Ankauf zahlen',
...
const en: Translations = {
  ...
  pageTitle: 'Register as Kitchen Dealer',
  pageSubtitle: 'Join our kitchen partner network and receive qualified leads directly from private kitchen sellers',
  pageBadge: 'Dealer Registration',
  benefitExclusiveTitle: 'Qualified Kitchen Leads',
  benefitExclusiveDesc: 'Inquiries directly from private kitchen sellers',
...
const nl: Translations = {
  ...
  pageTitle: 'Registreren als keukenhandelaar',
  pageSubtitle: 'Word onderdeel van ons keukenpartnernetwerk en ontvang gekwalificeerde leads van particuliere keukenverkopers',
  pageBadge: 'Dealer Registratie',
  benefitExclusiveTitle: 'Gekwalificeerde keuken-leads',
  benefitExclusiveDesc: 'Aanvragen rechtstreeks van particuliere keukenverkopers',
...
const fr: Translations = {
  ...
  placeholderCompanyName: 'Votre magasin de cuisines',
  ...
  buttonRegister: "S'inscrire en tant que partenaire",
  buttonRegistering: 'Inscription en cours...',
  buttonUploadingDocument: 'Téléchargement du document...',
  infoEmailConfirmation: "Après l'inscription, vous recevrez un e-mail pour confirmer votre adresse. Après confirmation, vous pourrez immédiatement vous connecter en tant que partenaire.",
  formOnlyForDealers: 'Ce formulaire est exclusivement réservé aux partenaires professionnels.',
  alreadyRegistered: 'Déjà inscrit ?',
  loginLink: 'Vers la connexion partenaire',
  privateCustomer: 'Client particulier ?',
  privateRegistrationLink: "Vers l'inscription particulier",
  pageTitle: "S'inscrire en tant que partenaire cuisine",
  pageSubtitle: 'Rejoignez notre réseau de partenaires cuisine et recevez des leads qualifiés directement de vendeurs privés de cuisines',
  pageBadge: 'Inscription Partenaire',
  benefitExclusiveTitle: 'Leads cuisine qualifiés',
  benefitExclusiveDesc: 'Demandes directement de vendeurs privés de cuisines',
...
const it: Translations = {
  ...
  placeholderCompanyName: 'Il vostro studio cucine',
  ...
  buttonRegister: 'Registrati come partner',
  buttonRegistering: 'Registrazione in corso...',
  buttonUploadingDocument: 'Caricamento documento...',
  infoEmailConfirmation: "Dopo la registrazione riceverete un'e-mail per confermare il vostro indirizzo. Dopo la conferma potrete accedere immediatamente come partner.",
  formOnlyForDealers: 'Questo modulo è riservato esclusivamente ai partner professionali.',
  alreadyRegistered: 'Già registrato?',
  loginLink: 'Vai al login partner',
  privateCustomer: 'Cliente privato?',
  privateRegistrationLink: 'Vai alla registrazione privata',
  pageTitle: 'Registrati come partner cucine',
  pageSubtitle: 'Entra a far parte della nostra rete di partner cucine e ricevi lead qualificati direttamente da venditori privati di cucine',
  pageBadge: 'Registrazione Partner',
  benefitExclusiveTitle: 'Lead cucine qualificati',
  benefitExclusiveDesc: 'Richieste direttamente da venditori privati di cucine',
...
const es: Translations = {
  ...
  pageTitle: 'Registrarse como socio de cocinas',
  pageSubtitle: 'Forme parte de nuestra red de socios de cocinas y reciba contactos cualificados directamente de vendedores particulares de cocinas',
  pageBadge: 'Registro de Socio',
  benefitExclusiveTitle: 'Leads cualificados de cocinas',
  benefitExclusiveDesc: 'Solicitudes directamente de vendedores particulares de cocinas',
...
const pt: Translations = {
  ...
  buttonRegister: 'Registar como parceiro',
  buttonRegistering: 'A registar...',
  buttonUploadingDocument: 'A carregar documento...',
  infoEmailConfirmation: 'Após o registo receberá um e-mail para confirmar o seu endereço. Após a confirmação poderá iniciar sessão imediatamente como parceiro.',
  formOnlyForDealers: 'Este formulário destina-se exclusivamente a parceiros profissionais.',
  alreadyRegistered: 'Já registado?',
  loginLink: 'Ir para o login',
  privateCustomer: 'Cliente particular?',
  privateRegistrationLink: 'Ir para o registo particular',
  pageTitle: 'Registar como parceiro de cozinhas',
  pageSubtitle: 'Faça parte da nossa rede de parceiros de cozinhas e receba contactos qualificados diretamente de vendedores particulares de cozinhas',
  pageBadge: 'Registo de Parceiro',
  benefitExclusiveTitle: 'Leads de cozinhas qualificados',
  benefitExclusiveDesc: 'Pedidos diretamente de vendedores particulares de cozinhas',
...
const pl: Translations = {
  ...
  pageTitle: 'Zarejestruj się jako partner kuchenny',
  pageSubtitle: 'Dołącz do naszej sieci partnerów kuchennych i otrzymuj kwalifikowane leady bezpośrednio od prywatnych sprzedawców kuchni',
  pageBadge: 'Rejestracja Partnera',
  benefitExclusiveTitle: 'Kwalifikowane leady kuchenne',
  benefitExclusiveDesc: 'Zapytania bezpośrednio od prywatnych sprzedawców kuchni',
