      ...
      <div className="flex items-center space-x-2 bg-muted/30 rounded-lg p-3">
        <Checkbox
          ...
          onCheckedChange={(checked) => {
            setSkipPhotos(checked as boolean);
            if (checked) {
              updateFormData({ photos: [] });
            }
          }}
        />
        <label htmlFor="skip-photos" className="text-sm cursor-pointer">
          Fotos später nachreichen – ich möchte erst mein Angebot erhalten
        </label>
      </div>
