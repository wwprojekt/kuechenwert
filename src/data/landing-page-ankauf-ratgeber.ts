...
export const wohnmobilAnkaufRatgeber: LandingPageConfig = {
  ...
  primaryCta: { text: "Verkauf jetzt starten", href: "/verkaufen/wizard" },
  secondaryCta: { text: "Erst kostenlos bewerten", href: "/wertrechner" },
  sections: [
    {
      title: "Verkaufsportale im ehrlichen Vergleich",
      content:
      ...
      items: [
        ...
        {
          title: "Kleinanzeigen.de (ehemals eBay Kleinanzeigen)",
          description:
        ...
        {
          title: "Facebook Marketplace & Gruppen",
          description:
        ...
        {
          title: "CaravanWert (Auktionsmodell)",
          description:
      ...
      ctaText: "Auktion ohne Risiko starten",
      ctaHref: "/verkaufen/wizard",
    },
    {
      title: "Privatverkauf vs. Händler — was ist wirklich besser?",
      content:
      ...
      items: [
        ...
        {
          title: "Händler-Inzahlungnahme: Pro",
          description:
        ...
        {
          title: "Händler-Inzahlungnahme: Contra",
          description:
        ...
        {
          title: "Auktionsplattform mit Händler-Bietergemeinschaft (CaravanWert-Modell): Pro",
          description:
        ...
        },
        {
          title: "Empfehlung",
          description:
            "Bei Standardfahrzeugen unter 60.000 €: Auktionsplattform meist die beste Balance. Bei Premium-Fahrzeugen ab 80.000 € oder Liebhaberstücken: Privatverkauf zusätzlich versuchen, parallel zur Auktion. Reine Händler-Inzahlungnahme nur, wenn Geschwindigkeit absolutes Muss ist.",
        },
      ],
    },
    {
      title: "Wohnmobil verkaufen: Schritt-für-Schritt-Anleitung",
      content:
        "Ob Sie den Privatverkauf oder die Auktionsplattform wählen — diese Vorbereitung müssen Sie in jedem Fall treffen. Investition: 4–6 Stunden, Effekt: 1.000–4.000 € Mehrerlös.",
      items: [
        {
          title: "Schritt 1: Aufbereitung & Reinigung",
          description:
        ...
        {
          title: "Schritt 2: Dokumente sammeln",
          description:
        ...
        {
          title: "Schritt 3: Hochwertige Fotos",
          description:
        ...
        {
          title: "Schritt 4: Preis ermitteln",
          description:
        ...
        {
          title: "Schritt 5: Inserat schreiben",
          description:
        ...
        {
          title: "Schritt 6: Verkaufskanäle starten",
          description:
            "Auktionsplattform aktivieren ODER Inserat auf 2–3 Privatverkaufsportalen schalten. Nicht alle Anrufe annehmen — selektieren Sie nach ernsthaftem Interesse.",
        },
        {
          title: "Schritt 7: Übergabe & Bezahlung",
          description:
      ...
      ctaText: "Direkt zur Auktion (Schritt 4–7 entfallen)",
      ctaHref: "/verkaufen/wizard",
    },
    {
      title: "Die häufigsten Fallen beim Wohnmobil-Verkauf",
      content:
        "10+ Jahre Marktexperience zeigen: Diese 6 Fehler kosten Verkäufer am häufigsten Geld oder Nerven.",
      items: [
        {
          title: "Falle 1: Überteuertes Inserat",
          description:
        ...
        {
          title: "Falle 3: Mängel verschweigen",
          description:
        ...
        {
          title: "Falle 4: Anzahlung von Käufer akzeptieren",
          description:
        ...
        {
          title: "Falle 5: Zahlung per Bargeld in großer Stückzahl",
          description:
        ...
        {
          title: "Falle 6: Probefahrt ohne Sicherheit",
          description:
    ...
    {
      title: "Schneller verkaufen ohne diese Fallen — die Auktion",
      content:
        "Die meisten dieser Fallen entfallen automatisch, wenn Sie über unsere Auktionsplattform verkaufen. Hier die wichtigsten Vorteile auf einen Blick.",
      items: [
        {
        ...
        {
          title: "Realistischer Preis ohne Verhandlungsstress",
          description:
        ...
        {
          title: "Sichere Bezahlung & Abholung",
          description:
            "Echtzeit-Banküberweisung gegen Übergabe. Deutschlandweite Abholung. Sie verlassen den eigenen Hof nicht.",
        },
      ],
      ctaText: "Auktion in 5 Minuten starten",
      ctaHref: "/verkaufen/wizard",
    },
  ],
  faqItems: [
    {
      question: "Welches Portal ist das beste für meinen Wohnmobil-Verkauf?",
      answer:
        "Das hängt von Ihren Prioritäten ab. Maximale Reichweite und Geduld: mobile.de + Kleinanzeigen. Schnell, sicher und marktgerecht: CaravanWert-Auktion. Liebhaberstücke mit speziellem Käuferprofil: zusätzlich Caraworld und Facebook-Gruppen.",
    },
    {
    ...
    {
      question: "Was kostet eine professionelle Aufbereitung?",
      answer:
    ...
    {
      question: "Brauche ich einen Anwalt für den Kaufvertrag?",
      answer:
    ...
    {
      question: "Wie schütze ich mich vor Gewährleistungsansprüchen?",
      answer:
    ...
    {
      question: "Was ist mit Kfz-Steuer und Versicherung nach dem Verkauf?",
      answer:
    ...
    {
      question: "Soll ich das Wohnmobil vor dem Verkauf abmelden?",
      answer:
    ...
    {
      question: "Wie erkenne ich Betrugsversuche?",
      answer:
    ...
    {
      question: "Macht es Sinn, mehrere Verkaufskanäle parallel zu nutzen?",
      answer:
        "Bei Privatverkauf ja: mobile.de + Kleinanzeigen + Caraworld erhöht die Reichweite. Bei Auktion über CaravanWert nicht nötig — 1.500+ Händler in einem 24-Stunden-Fenster sind quantitativ Maximum.",
    },
    {
      question: "Ist Bargeldzahlung erlaubt?",
      answer:
    ...
    {
      question: "Was wenn der Käufer das Fahrzeug nach dem Kauf zurückgeben will?",
      answer:
    ...
    {
      question: "Wie hoch sollte mein Mindestpreis bei der Auktion sein?",
      answer:
        "5–10 % unter dem Marktwert aus dem Wertrechner. Niedriger setzen ist riskant (Sie verkaufen dann unter Wert), höher setzen riskiert, dass die Auktion verfällt. Im Zweifel: realistisch ansetzen, Sie können nach erfolgloser Auktion immer eine zweite mit niedrigerem Mindestpreis starten.",
    },
    {
      question: "Was kostet die Verkaufsabwicklung über CaravanWert?",
      answer:
    ...
    {
      question: "Wie schnell habe ich nach erfolgreicher Auktion mein Geld?",
      answer:
        "In der Regel 24–48 Stunden nach Auktionsende. Der Händler vereinbart einen Übergabetermin (oft am nächsten Werktag), bringt das Geld per Echtzeit-Überweisung mit, prüft das Fahrzeug, übergibt das Geld und holt das Wohnmobil ab.",
    },
    {
      question: "Kann ich nach Auktionsstart noch absagen?",
      answer:
        "Bis zum Auktionsende: Sie können den Mindestpreis anpassen oder die Auktion zurückziehen. Nach Auktionsende mit gültigem Höchstgebot über Mindestpreis: Sie sind verkaufsverpflichtet (rechtsverbindlicher Vertrag mit Höchstbieter).",
    },
    {
      question: "Was wenn der Käufer-Händler bei der Übergabe Mängel findet?",
      answer:
